...
// Uma interrupção pode ser considerada uma task?
...
static void gpio_task_example(void* arg) // É uma tarefa (task) -> Tem "cara" de função e tem loop infinito
{
    uint32_t io_num;
    for (;;) {
...
/* ESSE TRECHO NÃO É NECESSÁRIO, APENAS INFORMATIVO, A PORTA PODE SER ADICIONADA E REMOVIDA PELO COMANDO
